 ...
 *
 * These describe the SHAPE only. Actual values come from mappers.
 * Never invent fields at the controller level — add them to the mapper
 * and update the corresponding contract here.
 */
